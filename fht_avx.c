...
void helper_double_29_recursive(double *buf, int depth) {
  ...
  if (depth == 11) {
    helper_double_29_recursive(buf + 0, 8);
    helper_double_29_recursive(buf + 256, 8);
    helper_double_29_recursive(buf + 512, 8);
    helper_double_29_recursive(buf + 768, 8);
    helper_double_29_recursive(buf + 1024, 8);
    helper_double_29_recursive(buf + 1280, 8);
    helper_double_29_recursive(buf + 1536, 8);
    helper_double_29_recursive(buf + 1792, 8);
    for (int j = 0; j < 2048; j += 2048) {
      for (int k = 0; k < 256; k += 4) {
        __asm__ volatile (
          "vmovupd (%0), %%ymm0\n"
